...
@section('content')
    <div>
        ...
        <form id="edit-article-form" action="{{action('ArticleController@postEditArticle')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea name="content" id="content" rows="20" onkeyup="textAreaAdjust(this)" style="overflow:hidden">{{$article->content}}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="password" value="{{$article->password}}">
            </div>
